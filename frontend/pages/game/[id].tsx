      ...
      socket.on('gameConnected', (response: GameConnectedResponse) => {
        ...
        socket.on('connectedAsPlayer', () => {
	      ...
	      if (e.key == "2") {
	        const w = screen[0].canvasEl.width;
	        const h = screen[0].canvasEl.height;
	        screen[0].drawRectangle(w / 4, h / 3 - 20, w / 2, 40);
	        screen[0].drawRectangle(w / 4, h / 3 * 2 - 20, w / 2, 40);
	      } else if (e.key == "3") {
	      	screen[0].drawRectangle(w / 4 - 20, 0, 40, h / 4);
		screen[0].drawRectangle(w / 4 * 3 - 20, 0, 40, h / 4);
		screen[0].drawRectangle(w / 4 - 20, h - h / 4, 40, h / 4);
		screen[0].drawRectangle(w / 4 * 3 - 20, h - h / 4, 40, h / 4);
	      }
